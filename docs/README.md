...
The documentation for these example designs is hosted at <https://qsfp28.ethernetfmc.com>
...
only wish to view the documentation, then please view it [here](https://qsfp28.ethernetfmc.com).
...
The block diagram on the Description page
(`docs/source/images/versal-mrmac-100g-block-diagram.png`) is generated from the Python/matplotlib
script `docs/source/images/gen_block_diagram.py`. If you change the architecture, edit that script
and regenerate the PNG (it is written next to the script):
