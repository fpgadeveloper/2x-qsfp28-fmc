...
#   port 0 = FMC slot 0 / DP0-3 (GTY bank 227, quad X0Y12-15, CMACE4_X0Y0)
...
# The KU5P's single CMAC (CMACE4_X0Y0) reaches the FMC quad via the IP's
# per-lane GT selection (GT group X0Y12~X0Y15) - verified with the
# cmac_usplus customization rules for xcku5p-ffvb676-2-e.
