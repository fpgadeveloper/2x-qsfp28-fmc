...
#
# Both QSFP28 ports, each a 1x100GbE (CAUI-4) CMAC:
#   port 0 = FMC slot 0 / DP0-3 (GTY bank 129, quad X0Y8-11,  CMACE4_X0Y0)
#   port 1 = FMC slot 1 / DP4-7 (GTY bank 130, quad X0Y12-15, CMACE4_X0Y1)
